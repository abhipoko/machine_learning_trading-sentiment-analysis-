...
event_dates_data = pd.read_csv('/Users/abhisheksonawane/Desktop/python prg/fessorpro/machine_learning_trading(sentiment analysis)/apple_events_new.csv')
...
stock_prices_data = pd.read_csv('/Users/abhisheksonawane/Desktop/python prg/fessorpro/machine_learning_trading(sentiment analysis)/historical_prices.csv', index_col=0)
...
daily_sentiment_scores = pd.read_csv('/Users/abhisheksonawane/Desktop/python prg/fessorpro/machine_learning_trading(sentiment analysis)/daily_sentiment_scores_2016_jan_2023_sep.csv', index_col=0)
